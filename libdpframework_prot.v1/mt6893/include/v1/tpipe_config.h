...
#define MAX_ISP_DUMP_HEX_PER_TILE_MSS (64)
#else
#define MAX_TILE_TOT_NO (1200)
#define MAX_ISP_DUMP_HEX_PER_TILE (256)
#define MAX_ISP_DUMP_HEX_PER_TILE_WPE (4)
...
#define MAX_TILE_HEIGHT_HW (16384)
...
#define HW_DIP_REG_CMP(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, top.ynr_gmap_ltm_mode, true, 0x00002058, 0x15022058, 0x00000400, 10, DIPCTL_D1A_DIPCTL_MISC_SEL, DIPCTL_YNR_GMAP_LTM_MODE)\    
