...
#define MAX_WPE_DUMP_HEX_PER_TILE_WPE (27)
...
#define WPE_SEL_DIP_A (0x10)
#define WPE_SEL_DIP_B (0x20)
#define WPE_CAL_AB_X (0x1)
#define WPE_CAL_AB_Y (0x10)
...
#define WPE_ERROR_MESSAGE_DATA(n, CMD) \
    ...
    CMD(n, WPE_MESSAGE_DUAL_CONIFG_ERROR)
...
#define WPE_TPIPE_SW_REG_LUT(CMD, a, b, c, d, e, f) \
	...
	/* dual mode */\
    CMD(a, b, c, d, e, f, sw_wpe.tpipe_sel_mode, TILE_SEL_CAL,, U)\
    CMD(a, b, c, d, e, f, sw_wpe.tpipe_dual_mode, TILE_DUAL_MODE,, U)\
...
#define WPE_TPIPE_HW_REG_LUT(CMD, a, b, c, d, e, f) \
	...
	CMD(a, b, c, d, e, f, top_wpe.wpeo2_en, WPE_A_CTL_DMA_EN, WPEO2_EN, U)\
	/* CAHCI */\
...
#define WPE_TPIPE_TDR_DUMP_LUT(CMD, a, b, c, d, e, f, max_count, result, word_no)\
    ...
    CMD(a, b, c, d, e, f, max_count, result, word_no, 1, true, WPEO2_EN, 0x00000800, 11, U)\
	/* VECI */\
    ...
    /* WPEO */\
    CMD(a, b, c, d, e, f, max_count, result, word_no, 24, TDR_REG_CHECK_EN(a, top_wpe.wpeo2_en), WPEO2_OFFSET_ADDR, 0x0FFFFFFF, 0, U)\
    CMD(a, b, c, d, e, f, max_count, result, word_no, 25, TDR_REG_CHECK_EN(a, top_wpe.wpeo2_en), WPEO2_XSIZE, 0x0000FFFF, 0, U)\
    CMD(a, b, c, d, e, f, max_count, result, word_no, 25, TDR_REG_CHECK_EN(a, top_wpe.wpeo2_en), WPEO2_YSIZE, 0xFFFF0000, 16, U)\
    CMD(a, b, c, d, e, f, max_count, result, word_no, 26, TDR_REG_CHECK_EN(a, top_wpe.wpeo2_en), WPEO2_XOFFSET, 0x0000FFFF, 0, U)\
    CMD(a, b, c, d, e, f, max_count, result, word_no, 26, TDR_REG_CHECK_EN(a, top_wpe.wpeo2_en), WPEO2_YOFFSET, 0xFFFF0000, 16, U)\
