...
#define MDP_TILE_FUNC_ID_ENUM_DECLARE \
    ...
    TILE_FUNC_CAMIN_ID = TILE_FUNC_MDP_BASE + 8, \
    TILE_FUNC_CAMIN2_ID,\
    TILE_FUNC_CAMIN3_ID,\
    TILE_FUNC_CAMIN4_ID,\
    TILE_FUNC_RDMA0_ID,\
...
#define MDP_TILE_HW_REG_LUT(CMD, a, b, c, d, e) \
    ...
    CMD(a, b, c, d, e, int, enable_ISP3,, CAMIN3_EN,,,,,, enable_ISP3,,)\
    CMD(a, b, c, d, e, int, enable_ISP4,, CAMIN4_EN,,,,,, enable_ISP4,,)\
    CMD(a, b, c, d, e, int, enable_MDP_RDMA0,, RDMA0_EN,,,,,, enable_MDP_RDMA0,,)\
    CMD(a, b, c, d, e, int, enable_MDP_RDMA1,, RDMA1_EN,,,,,, enable_MDP_RDMA1,,)\
    CMD(a, b, c, d, e, int, enable_MDP_RDMA2,, RDMA2_EN,,,,,, enable_MDP_RDMA2,,)\
    CMD(a, b, c, d, e, int, enable_MDP_RDMA3,, RDMA3_EN,,,,,, enable_MDP_RDMA3,,)\
    CMD(a, b, c, d, e, int, enable_MDP_FG0,, FG0_EN,,,,,, enable_MDP_FG0,,)\
    CMD(a, b, c, d, e, int, enable_MDP_FG1,, FG1_EN,,,,,, enable_MDP_FG1,,)\
    ...
    CMD(a, b, c, d, e, int, enable_MDP_HDR1,, HDR1_EN,,,,,, enable_MDP_HDR1,,)\
    CMD(a, b, c, d, e, int, enable_MDP_COLOR0,, COLOR0_EN,,,,,, enable_MDP_COLOR0,,)\
    CMD(a, b, c, d, e, int, enable_MDP_COLOR1,, COLOR1_EN,,,,,, enable_MDP_COLOR1,,)\
    CMD(a, b, c, d, e, int, enable_MDP_AAL0,, AAL0_EN,,,,,, enable_MDP_AAL0,,)\
    CMD(a, b, c, d, e, int, enable_MDP_AAL1,, AAL1_EN,,,,,, enable_MDP_AAL1,,)\
    CMD(a, b, c, d, e, int, enable_MDP_AAL2,, AAL2_EN,,,,,, enable_MDP_AAL2,,)\
    CMD(a, b, c, d, e, int, enable_MDP_AAL3,, AAL3_EN,,,,,, enable_MDP_AAL3,,)\
    ...
    CMD(a, b, c, d, e, int, enable_MDP_PRZ3,, PRZ3_EN,,,,,, enable_MDP_PRZ3,,)\
    ...
    CMD(a, b, c, d, e, int, enable_MDP_TDSHP2,, TDSHP2_EN,,,,,, enable_MDP_TDSHP2,,)\
    CMD(a, b, c, d, e, int, enable_MDP_TDSHP3,, TDSHP3_EN,,,,,, enable_MDP_TDSHP3,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WROT0,, WROT0_EN,,,,,, enable_MDP_WROT0,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WROT1,, WROT1_EN,,,,,, enable_MDP_WROT1,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WROT2,, WROT2_EN,,,,,, enable_MDP_WROT2,,)\
    CMD(a, b, c, d, e, int, enable_MDP_WROT3,, WROT3_EN,,,,,, enable_MDP_WROT3,,)\
    CMD(a, b, c, d, e, int, enable_MDP_TCC0,, TCC0_EN,,,,,, enable_MDP_TCC0,,)\
    CMD(a, b, c, d, e, int, enable_MDP_TCC1,, TCC1_EN,,,,,, enable_MDP_TCC1,,)\
    CMD(a, b, c, d, e, int, enable_MDP_TCC2,, TCC2_EN,,,,,, enable_MDP_TCC2,,)\
    CMD(a, b, c, d, e, int, enable_MDP_TCC3,, TCC3_EN,,,,,, enable_MDP_TCC3,,)\
    /* MUX - mout */\
    ...
    CMD(a, b, c, d, e, int, DISP_isp3_mout_en, ISP2_MOUT_EN, CAMIN3_OUT,,,,,, DISP_isp3_mout_en,,)\
    CMD(a, b, c, d, e, int, DISP_isp4_mout_en, ISP3_MOUT_EN, CAMIN4_OUT,,,,,, DISP_isp4_mout_en,,)\
    ...
    CMD(a, b, c, d, e, int, DISP_mdp_rdma2_mout_en, MDP_RDMA2_MOUT_EN, RDMA2_OUT,,,,,, DISP_mdp_rdma2_mout_en,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_rdma3_mout_en, MDP_RDMA3_MOUT_EN, RDMA3_OUT,,,,,, DISP_mdp_rdma3_mout_en,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_aal0_mout_en, MDP_AAL0_MOUT_EN, AAL0_OUT,,,,,, DISP_mdp_aal0_mout_en,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_aal1_mout_en, MDP_AAL1_MOUT_EN, AAL1_OUT,,,,,, DISP_mdp_aal1_mout_en,,)\
    /* MUX - sel in */\
    ...
    CMD(a, b, c, d, e, int, DISP_mdp_pq2_sel, MDP_PQ2_SEL_IN, PQ2_SEL,,,,,, DISP_mdp_pq2_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_pq3_sel, MDP_PQ3_SEL_IN, PQ3_SEL,,,,,, DISP_mdp_pq3_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_hdr0_sel, MDP_HDR0_SEL_IN, HDR0_SEL,,,,,, DISP_mdp_HDR0_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_hdr1_sel, MDP_HDR1_SEL_IN, HDR1_SEL,,,,,, DISP_mdp_HDR1_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_prz0_sel, MDP_RSZ0_SEL_IN, PRZ0_SEL,,,,,, DISP_mdp_prz0_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_prz1_sel, MDP_RSZ1_SEL_IN, PRZ1_SEL,,,,,, DISP_mdp_prz1_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_prz2_sel, MDP_RSZ2_SEL_IN, PRZ2_SEL,,,,,, DISP_mdp_prz2_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_prz3_sel, MDP_RSZ3_SEL_IN, PRZ3_SEL,,,,,, DISP_mdp_prz3_sel,,)\
    ...
    CMD(a, b, c, d, e, int, DISP_mdp_wrot2_sel, MDP_WROT2_SEL_IN, WROT2_SEL,,,,,, DISP_mdp_wrot2_sel,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_wrot3_sel, MDP_WROT3_SEL_IN, WROT3_SEL,,,,,, DISP_mdp_wrot3_sel,,)\
    /* MUX - sel out */\
    ...
    CMD(a, b, c, d, e, int, DISP_mdp_tcc0_sout, MDP_TCC0_SOUT_SEL, TCC0_SOUT,,,,,, DISP_mdp_tcc0_sout,,)\
    CMD(a, b, c, d, e, int, DISP_mdp_tcc1_sout, MDP_TCC1_SOUT_SEL, TCC1_SOUT,,,,,, DISP_mdp_tcc1_sout,,)\
