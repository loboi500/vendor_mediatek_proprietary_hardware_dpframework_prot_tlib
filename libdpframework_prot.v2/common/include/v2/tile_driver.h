...
#define TILE_SEL_SUPPORT_LIST(CMD, a, b, c, d, e, f) \
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A)/* 1, DIP_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_WPE_A)/* 10, WPE_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_WPE_A)/* 11, DIP_A+WPE_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_MDP_A)/* 10001, DIP_A+MDP_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_WPE_A)/* 10010, WPE_A+MDP_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_WPE_A + TILE_SEL_MDP_A)/* 10011, WPE_A+DIP_A+MDP_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_B)/* 2, DIP_B */\
	CMD(a, b, c, d, e, f, TILE_SEL_WPE_B)/* 20, WPE_B */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_B + TILE_SEL_WPE_B)/* 22, DIP_B+WPE_B */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_B + TILE_SEL_MDP_B)/* 20002, DIP_B+MDP_B */\
	CMD(a, b, c, d, e, f, TILE_SEL_WPE_B + TILE_SEL_MDP_B)/* 20020, WPE_B+MDP_B */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_B + TILE_SEL_WPE_B + TILE_SEL_MDP_B)/* 20022, WPE_B+DIP_B+MDP_B */\
	CMD(a, b, c, d, e, f, TILE_SEL_MFB_A)/* 100000, MFB_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_MFB_A)/* 100001, MFB_A+DIP_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_MSS_A)/* 100, MSS_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_MSS_A)/* 101, MSS_A+DIP_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_WPE_A + TILE_SEL_MSS_A)/* 111, MSS_A+DIP_A+WPE_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_MFB_A + TILE_SEL_MSS_A)/* 100100, MSS_A+MFB_A */\
	CMD(a, b, c, d, e, f, TILE_SEL_DIP_A + TILE_SEL_MSS_A + TILE_SEL_MFB_A)/* 100101, MSS_A+MFB_A+DIP_A */\
