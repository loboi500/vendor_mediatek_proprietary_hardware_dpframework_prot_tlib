...
#define MAX_TILE_WIDTH_HW_MSS (256) /* 0: read tile width from INIT_PROPERTY_LUT, 256: unified HW tile width */
#define MAX_TILE_WIDTH_MSS 0 /* 0: read tile width from INIT_PROPERTY_LUT, MAX_TILE_WIDTH_HW_MSS: unified HW tile width */
#define MAX_TILE_HEIGHT_HW (65536)
#define MAX_ISP_MASK_HEX_PER_TILE (342)
#define MAX_ISP_MASK_HEX_PER_TILE_WPE (4)
#define MAX_ISP_MASK_HEX_PER_TILE_MFB (128)
#define MAX_ISP_MASK_HEX_PER_TILE_MSS (128)
...
#define MAX_ISP_TILE_TDR_HEX_NO_MSS (MAX_TILE_TOT_NO*MAX_ISP_DUMP_HEX_PER_TILE_MSS)
...
#define MAX_ISP_DUMP_HEX_PER_TILE_INTERNAL_MSS (32)
#define MAX_ISP_MASK_HEX_PER_TILE_INTERNAL_MSS (32)
...
#define MAX_ISP_TILE_TDR_HEX_NO_INTERNAL_MSS (MAX_TILE_TOT_NO*MAX_ISP_DUMP_HEX_PER_TILE_INTERNAL_MSS)
...
#define MAX_TILE_FUNC_SUBRDMA_NO (48)
...
#define TILE_SEL_MDP_B (0x20000)
#define TILE_SEL_MFB_A (0x100000)
#define TILE_SEL_MSS_A (0x100)
#define TILE_SEL_COUNT (TILE_SEL_COUNT_A + TILE_SEL_COUNT_B)
#define TILE_SEL_COUNT_A ((TILE_SEL_DIP_A?1:0) + (TILE_SEL_WPE_A?1:0) + (TILE_SEL_MFB_A?1:0)+ (TILE_SEL_MSS_A?1:0))
...
#define TILE_SEL_MSS_FIRST(tile_group) (((tile_group) & TILE_SEL_MSS_A)?TILE_SEL_MSS_A:0)
#define TILE_SEL_GROUP_COUNT(tile_group) (((tile_group) & TILE_SEL_SUM_A)?1:0) + (((tile_group) & TILE_SEL_SUM_B)?1:0)
#define TILE_CAL_AB_X (0x1)
#define TILE_CAL_AB_Y (0x10)

/* PLATFORM parameters */
/* a, b, c, d, e, f reserved */
/* support mode */
#define TILE_SEL_SUPPORT_LIST(CMD, a, b, c, d, e, f) \
	CMD(a, b, c, d, e, f, 0x000001)/* 1, DIP_A */\
	CMD(a, b, c, d, e, f, 0x000010)/* 10, WPE_A */\
	CMD(a, b, c, d, e, f, 0x000011)/* 11, DIP_A+WPE_A */\
	CMD(a, b, c, d, e, f, 0x010001)/* 10001, DIP_A+MDP_A */\
	CMD(a, b, c, d, e, f, 0x010010)/* 10010, WPE_A+MDP_A */\
	CMD(a, b, c, d, e, f, 0x010011)/* 10011, WPE_A+DIP_A+MDP_A */\
	CMD(a, b, c, d, e, f, 0x000002)/* 2, DIP_B */\
	CMD(a, b, c, d, e, f, 0x000020)/* 20, WPE_B */\
	CMD(a, b, c, d, e, f, 0x000022)/* 22, DIP_B+WPE_B */\
	CMD(a, b, c, d, e, f, 0x020002)/* 20002, DIP_B+MDP_B */\
	CMD(a, b, c, d, e, f, 0x020020)/* 10010, WPE_B+MDP_B */\
	CMD(a, b, c, d, e, f, 0x020022)/* 10011, WPE_B+DIP_B+MDP_B */\
	CMD(a, b, c, d, e, f, 0x100000)/* 100000, MFB_A */\
	CMD(a, b, c, d, e, f, 0x100001)/* 100001, MFB_A+DIP_A */\
	CMD(a, b, c, d, e, f, 0x000100)/* 1000000, MSS_A */\
	CMD(a, b, c, d, e, f, 0x000101)/* 1000001, MSS_A+DIP_A */\
	CMD(a, b, c, d, e, f, 0x000111)/* 1000001, MSS_A+DIP_A+WPE_A */\
	CMD(a, b, c, d, e, f, 0x100100)/* 1000001, MSS_A+MFB_A */\
	CMD(a, b, c, d, e, f, 0x100101)/* 1000101, MSS_A+MFB_A+DIP_A */\
...
typedef enum TILE_FUNC_ID_ENUM
{
	...
	TILE_FUNC_CRP_D1_ID,/* 1058 */
	TILE_FUNC_CRP_D4_ID,/* 1059 */
	TILE_FUNC_G2CX_D1_ID,/* 1060 */
	TILE_FUNC_C42_D1_ID,/* 1061 */
	TILE_FUNC_SRZ_D1_ID,/* 1062 */
	TILE_FUNC_SRZ_D3_ID,/* 1063 */
	TILE_FUNC_SRZ_D4_ID,/* 1064 */
	TILE_FUNC_CRZ_D1_ID,/* 1065 */
	TILE_FUNC_SLK_D1_ID,/* 1066 */
	TILE_FUNC_SLK_D2_ID,/* 1067 */
	TILE_FUNC_SLK_D3_ID,/* 1068 */
	TILE_FUNC_SLK_D4_ID,/* 1069 */
	TILE_FUNC_SLK_D5_ID,/* 1070 */
	TILE_FUNC_SLK_D6_ID,/* 1071 */
	TILE_FUNC_YNR_LTM_D1_ID,/* 1072 */
	TILE_FUNC_YNR_PAD_D1_ID,/* 1073 */
	TILE_FUNC_NDG_D1_ID,/* 1074 */
	TILE_FUNC_NDG_PAD_ID,/* 1075 */
	TILE_FUNC_YNR_D1_ID,/* 1076 */
	TILE_FUNC_C24_D1_ID,/* 1077 */
	TILE_FUNC_C24_D2_ID,/* 1078 */
	TILE_FUNC_C24_D3_ID,/* 1079 */
	TILE_FUNC_C2G_D1_ID,/* 1080 */
	TILE_FUNC_IGGM_D1_ID,/* 1081 */
	TILE_FUNC_CCM_D3_ID,/* 1082 */
	TILE_FUNC_LCE_D1_ID,/* 1083 */
	TILE_FUNC_DCE_D1_ID,/* 1084 */
	TILE_FUNC_DCES_D1_ID,/* 1085 */
	TILE_FUNC_DCESO_D1_ID,/* 1086 */
	TILE_FUNC_GGM_D3_ID,/* 1087 */
	TILE_FUNC_G2C_D1_ID,/* 1088 */
	TILE_FUNC_C02_D1_ID,/* 1089 */
	TILE_FUNC_C02_OUT_CROP_D1_ID,/* 1090 */
	TILE_FUNC_C02_D2_ID,/* 1091 */
	TILE_FUNC_C02_OUT_CROP_D2_ID,/* 1092 */
	TILE_FUNC_CRSP_D1_ID,/* 1093 */
	TILE_FUNC_CRSP_IN_CROP_D1_ID,/* 1094 */
	TILE_FUNC_C42_D2_ID,/* 1095 */
	TILE_FUNC_EE_D1_ID,/* 1096 */
	TILE_FUNC_CNR_PAD_D1_ID,/* 1097 */
	TILE_FUNC_NDG_D2_ID,/* 1098 */
	TILE_FUNC_NDG2_PAD_ID,/* 1099 */
	TILE_FUNC_CNR_D1_ID,/* 1100 */
	TILE_FUNC_CNR_BOK_D1_ID,/* 1101 */
	TILE_FUNC_CRP_D2_ID,/* 1102 */
	TILE_FUNC_COLOR_D1_ID,/* 1103 */
	TILE_FUNC_NR3D_D1_ID,/* 1104 */
	TILE_FUNC_NR3D_IN_CROP_D1_ID,/* 1105 */
	TILE_FUNC_MIX_D1_ID,/* 1106 */
	TILE_FUNC_MIX_D2_ID,/* 1107 */
	TILE_FUNC_MIX_D3_ID,/* 1108 */
	TILE_FUNC_AKS_D1_ID,/* 1109 */
    TILE_FUNC_PAK_D1_ID,/* 1110 */
    TILE_FUNC_PAKG_D1_ID,/* 1111 */
    TILE_FUNC_PAK_D2_ID,/* 1112 */
    TILE_FUNC_PAK_D3_ID,/* 1113 */
    TILE_FUNC_PAK_D4_ID,/* 1114 */
    TILE_FUNC_PAK_D6_ID,/* 1115 */
    TILE_FUNC_PAK_D7_ID,/* 1116 */
    TILE_FUNC_PAK_D8_ID,/* 1117 */
	TILE_FUNC_PLNR_D1_ID,/* 1118 */
	TILE_FUNC_PLNR_D2_ID,/* 1119 */
	TILE_FUNC_PLNW_D1_ID,/* 1120 */
	TILE_FUNC_PLNW_D2_ID,/* 1121 */
	TILE_FUNC_DFE_D1_ID,/* 1122 */
	TILE_FUNC_FEO_D1_ID,/* 1123 */
	TILE_FUNC_MCRP_D1_ID,/* 1124 */
	TILE_FUNC_MCRP_D2_ID,/* 1125 */
	TILE_FUNC_FM_D1_ID,/* 1126 */
	TILE_FUNC_BYPASS_ID,/* 1127 */
	TILE_FUNC_BYPASS_SMT_FULLG_ID,/* 1128 */
	TILE_FUNC_BYPASS_ZERO_ID,/* 1129 */
	TILE_FUNC_BYTE42_ID,/* 1130 */
	TILE_FUNC_BYTE24_ID,/* 1131 */
	TILE_FUNC_BC_D1_ID,/* 1132 */
	TILE_FUNC_BC_D2_ID,/* 1133 */
	TILE_FUNC_BC_D3_ID,/* 1134 */
	TILE_FUNC_BC_D4_ID,/* 1135 */
	TILE_FUNC_BC_D5_ID,/* 1136 */
	TILE_FUNC_BC_D6_ID,/* 1137 */
	TILE_FUNC_BC_D7_ID,/* 1138 */
	TILE_FUNC_BC_D8_ID,/* 1139 */
	TILE_FUNC_BC_D9_ID,/* 1140 */
	TILE_FUNC_BC_D10_ID,/* 1141 */
	TILE_FUNC_BC_D11_ID,/* 1142 */
	TILE_FUNC_BC_D12_ID,/* 1143 */
	TILE_FUNC_BC_D13_ID,/* 1144 */
	TILE_FUNC_BC_D14_ID,/* 1145 */
	TILE_FUNC_BC_D15_ID,/* 1146 */
	TILE_FUNC_BC_D16_ID,/* 1147 */
	TILE_FUNC_BC_D17_ID,/* 1148 */
	TILE_FUNC_BC_D18_ID,/* 1149 */
	TILE_FUNC_BC_D19_ID,/* 1150 */
	TILE_FUNC_BC_D20_ID,/* 1151 */
    TILE_FUNC_WPE_DL_ID,/* 1152 */
	TILE_FUNC_MFB_WT_ID,/* 1153 */
    TILE_FUNC_MFB_BLD_ID,/* 1154 */
	TILE_FUNC_MFB_C02_ID,/* 1155 */
	TILE_FUNC_MFB_C02_OUT_CROP_ID,/* 1156 */
    TILE_FUNC_MSF_ID,/* 1157 */
    TILE_FUNC_MSF_RDMA_BASEIY_ID,/* 1158 */
    TILE_FUNC_MSF_RDMA_BASEIC_ID,/* 1159 */
    TILE_FUNC_MSF_RDMA_REFIY_ID,/* 1160 */
    TILE_FUNC_MSF_RDMA_REFIC_ID,/* 1161 */
    TILE_FUNC_MSF_LPF_BASEIY_ID,/* 1162 */
    TILE_FUNC_MSF_LPF_BASEIC_ID,/* 1163 */
    TILE_FUNC_MSF_LPF_REFIY_ID,/* 1164 */
    TILE_FUNC_MSF_LPF_REFIC_ID,/* 1165 */
    TILE_FUNC_MSF_RDMA_DSIY_ID,/* 1166 */
    TILE_FUNC_MSF_RDMA_DSIC_ID,/* 1167 */
    TILE_FUNC_MSF_YURZ_DSI_ID,/* 1168 */
    TILE_FUNC_MSF_CURZ_DSI_ID,/* 1169 */
    TILE_FUNC_MSF_RDMA_IDIY_ID,/* 1170 */
    TILE_FUNC_MSF_RDMA_IDIC_ID,/* 1171 */
    TILE_FUNC_MSF_YURZ_IDI_ID,/* 1172 */
    TILE_FUNC_MSF_CURZ_IDI_ID,/* 1173 */
    TILE_FUNC_MSF_SLK_ID,/* 1174 */
	TILE_FUNC_MSF_RDMA_WEI_ID,/* 1175 */
    TILE_FUNC_MSF_RDMA_DSWI_ID,/* 1176 */
    TILE_FUNC_MSF_YURZ_DSWI_ID,/* 1177 */
    TILE_FUNC_MSF_RDMA_CONFI_ID,/* 1178 */
    TILE_FUNC_MSF_YURZ_CONFI_ID,/* 1179 */
    TILE_FUNC_MSF_CRP_FSO_ID,/* 1180 */
    TILE_FUNC_MSF_CRP_WEO_ID,/* 1181 */
    TILE_FUNC_MSF_CRP_DSWO_ID,/* 1182 */
    TILE_FUNC_MSF_UNP_BASEIY_ID,/* 1183 */
    TILE_FUNC_MSF_UNP_BASEIC_ID,/* 1184 */
    TILE_FUNC_MSF_UNP_REFIY_ID,/* 1185 */
    TILE_FUNC_MSF_UNP_REFIC_ID,/* 1186 */
    TILE_FUNC_MSF_UNP_DSIY_ID,/* 1187 */
    TILE_FUNC_MSF_UNP_DSIC_ID,/* 1188 */
    TILE_FUNC_MSF_PAK_FSOY_ID,/* 1189 */
    TILE_FUNC_MSF_PAK_FSOC_ID,/* 1190 */
    TILE_FUNC_MSF_WDMA_FSOY_ID,/* 1191 */
    TILE_FUNC_MSF_WDMA_FSOC_ID,/* 1192 */
    TILE_FUNC_MSF_WDMA_WEO_ID,/* 1193 */
    TILE_FUNC_MSF_WDMA_DSWO_ID,/* 1194 */
	TILE_FUNC_MSF_VYUVCONV_D1A_ID,/* 1195 */
	TILE_FUNC_MSF_VYUVCONV_D1B_ID,/* 1196 */
	TILE_FUNC_MSF_VYUVCONV_D1C_ID,/* 1197 */
	TILE_FUNC_MSF_VYUVCONV_D1D_ID,/* 1198 */
	TILE_FUNC_MSF_VYUVCONV_D1E_ID,/* 1199 */
	TILE_FUNC_MSF_VYUVCONV_D1F_ID,/* 1200 */
	TILE_FUNC_MSF_VYUVCONV_D1G_ID,/* 1201 */
	TILE_FUNC_MSF_VYUVCONV_D1H_ID,/* 1202 */
	TILE_FUNC_MSF_VYUVCONV_D1I_ID,/* 1203 */
	TILE_FUNC_MSF_VYUVCONV_D1J_ID,/* 1204 */
	TILE_FUNC_MSF_VYUVCONV_D1K_ID,/* 1205 */
	TILE_FUNC_MSF_VYUVCONV_D1M_ID,/* 1206 */
	TILE_FUNC_MSF_VYUVCONV_D1N_ID,/* 1207 */
    TILE_FUNC_MSF_YDRZ_BASEI_ID,/* 1208 */
    TILE_FUNC_MSF_YURZ_BASEI_ID,/* 1209 */
    TILE_FUNC_MSF_CDRZ_BASEI_ID,/* 1210 */
    TILE_FUNC_MSF_CURZ_BASEI_ID,/* 1211 */
    TILE_FUNC_MSF_YDRZ_REFI_ID,/* 1212 */
    TILE_FUNC_MSF_YURZ_REFI_ID,/* 1213 */
    TILE_FUNC_MSF_CDRZ_REFI_ID,/* 1214 */
    TILE_FUNC_MSF_CURZ_REFI_ID,/* 1215 */
	TILE_FUNC_MSF_CRSP_IN_CROP_ID,/* 1216 */
	TILE_FUNC_MSF_CRSP_ID,/* 1217 */
	TILE_FUNC_MSF_VLDS_D1A_ID,/* 1218 */
	TILE_FUNC_LPCNR_D1A_ID,/* 1219 */
	TILE_FUNC_SMT_D5_ID,/* 1220 */
	TILE_FUNC_SMT_D6_ID,/* 1221 */
	TILE_FUNC_BCV_D2_ID,/* 1222 */
	TILE_FUNC_YUFD_L_D1_ID,/* 1223 */
	TILE_FUNC_YUFD_C_D1_ID,/* 1224 */
	TILE_FUNC_UNP_D5_ID,/* 1225 */
	TILE_FUNC_UNP_D16_ID,/* 1226 */
	TILE_FUNC_CRP_D3_ID,/* 1227 */
	TILE_FUNC_PAK_D5_ID,/* 1228 */
	TILE_FUNC_PAK_D16_ID,/* 1229 */
    TILE_FUNC_SMTI_D5_ID,/* 1230 */
    TILE_FUNC_SMTI_D6_ID,/* 1231 */
    TILE_FUNC_SMTO_D5_ID,/* 1232 */
    TILE_FUNC_SMTO_D6_ID,/* 1233 */
    TILE_FUNC_UFBCD_D1_ID,/* 1234 */
    TILE_FUNC_UFBCD_CROP_D1_ID,/* 1235 */
    TILE_FUNC_UFBCE_D1_ID,/* 1236 */
	TILE_FUNC_MSS_RDMA_MSSIY_ID,/* 1237 */
	TILE_FUNC_MSS_RDMA_MSSIC_ID,/* 1238 */
	TILE_FUNC_MSS_MSSIY_UNP_ID,/* 1239 */
	TILE_FUNC_MSS_MSSIC_UNP_ID,/* 1240 */
	TILE_FUNC_MSS_DRZ_YDRZ_ID,/* 1241 */
	TILE_FUNC_MSS_DRZ_VDRZ_ID,/* 1242 */
	TILE_FUNC_MSS_DRZ_CDRZ_ID,/* 1243 */
	TILE_FUNC_MSS_CRP_DRZY_ID,/* 1244 */
	TILE_FUNC_MSS_CRP_DRZC_ID,/* 1245 */
	TILE_FUNC_MSS_MSSOY_PAK_ID,/* 1246 */
	TILE_FUNC_MSS_MSSOC_PAK_ID,/* 1247 */
	TILE_FUNC_MSS_WDMA_MSSOY_ID,/* 1248 */
	TILE_FUNC_MSS_WDMA_MSSOC_ID,/* 1249 */
	TILE_FUNC_MSS_RDMA_OMCIY_ID,/* 1250 */
	TILE_FUNC_MSS_RDMA_OMCIC_ID,/* 1251 */
	TILE_FUNC_MSS_RDMA_OMCIMV_ID,/* 1252 */
	TILE_FUNC_MSS_OMC_ID,/* 1253 */
	TILE_FUNC_MSS_CRP_OMCY_ID,/* 1254 */
	TILE_FUNC_MSS_CRP_OMCC_ID,/* 1255 */
	TILE_FUNC_MSS_OMCOY_PAK_ID,/* 1256 */
	TILE_FUNC_MSS_OMCOC_PAK_ID,/* 1257 */
	TILE_FUNC_MSS_WDMA_OMCOY_ID,/* 1258 */
	TILE_FUNC_MSS_WDMA_OMCOC_ID,/* 1259 */
	TILE_FUNC_MSS_VLDS_ID,/* 1260 */
	TILE_FUNC_MSS_CRSP_ID,/* 1261 */
	TILE_FUNC_MSS_VYUVCONV_D1A_ID,/* 1262 */
	TILE_FUNC_MSS_VYUVCONV_D1B_ID,/* 1263 */
	TILE_FUNC_MSS_VYUVCONV_D1C_ID,/* 1264 */
	TILE_FUNC_MSS_VYUVCONV_D1D_ID,/* 1265 */
	TILE_FUNC_MSS_VYUVCONV_D1E_ID,/* 1266 */
	TILE_FUNC_MSS_VYUVCONV_D1F_ID,/* 1267 */
	TILE_FUNC_MSS_VYUVCONV_D1G_ID,/* 1268 */
	TILE_FUNC_MSS_VYUVCONV_D1H_ID,/* 1269 */
	TILE_FUNC_MSS_VYUVCONV_D1I_ID,/* 1270 */
	TILE_FUNC_MSS_VYUVCONV_D1J_ID,/* 1271 */
	TILE_FUNC_MSS_VYUVCONV_D1K_ID,/* 1272 */
	TILE_FUNC_MSS_VYUVCONV_D1L_ID,/* 1273 */
	TILE_FUNC_MSS_VYUVCONV_D1M_ID,/* 1274 */
	TILE_FUNC_MSS_BYPASS_ID,/* 1275 */
	TILE_FUNC_MSF_VLDM_0_ID,/* 1276 */
	TILE_FUNC_MSF_VLDM_1_ID,/* 1277 */
    TILE_FUNC_MFB_PAD_ID,/* 1278 */
...
#define CAM_IN_FMT_BAYER_19	    (19)/* bayer 20 */
#define CAM_IN_FMT_BAYER_24	    (20)
#define CAM_IN_FMT_BAYER_18	    (21)/* bayer 20 */
#define CAM_IN_FMT_BAYER_22	    (22)/* bayer 24 */
/* RGB format */
...
#define UFBC_AU_BIT  (4)
#define UFBC_AU_SIZE (1<<UFBC_AU_BIT)
#define UFBCE_TILE_SIZE  (16)
/* error enum */
...
#define TILE_CPP_CODE_PRINTF_ISP_REG_ADDR_NAME(a, b, c, d, e, f, g, h, i, j, k, m, n, p, q,...) \
	{\
		unsigned int temp_addr = (size_t)offsetof(d, m) + (e);\
		if ((a) < temp_addr)\
		{\
			if ((a) == (b))\
			{\
...
#define TILE_FREAD_ISP_REG_ADDR_VAL(a, b, c, d, e, f, g, h, i, j, k, m, n, p,...) \
	...
	{\
		(c) = true;\
		ISP_BITS(((d).val), m, n) |= 0xFFFFFFFF;\
		(e).flag->i = ISP_BITS(((d).val), m, n);\
		ISP_REG(((d).val), m) = (b);\
...
#define TILE_WRAPPER_DATA_PRINT_CPP(a, b, c, d, e, f, g, h, i, j,...) b(a, "%s %s%s%d\r\n", d, #h, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR, (c)->i);
#define TILE_WRAPPER_DATA_PRINT_CPP_DEBUG(a, b, c, d, e, f, g, h, i, j,...) b(a, "%s %s%s%d\r\n", d, #i, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR, (c)->i);
...
#define TILE_WRAPPER_ISP_HW_TO_REG_COPY(a, b, c, d, e, f, g, h, i, j, k, m, n,...) \
    (c)->i = (int)ISP_BITS((a), m, n);\
    (d)->i = (int)ISP_BITS((b), m, n);\
...
#define TILE_WRAPPER_PLATFORM_PRINT_TXT_BY_FLAG_WITH_REG_CHECK_ISP(a, b, c, d, e, f, g, h, i, j, k, m, n, p,...) \
    ...
    {\
		...
		{\
            if (((b)->i & (e).flag->i) == (int)((e).val->i))\
            {\
                fprintf(a, "%s %s%s%s%d %s%s\r\n", TPIPE_DEBUG_DUMP_HEADER, #h, #j, TILE_DEBUG_SPACE_EQUAL_SYMBOL_STR,\
                    (b)->i, (k)?LOG_REMARK_MUST_FILL_STR:"", LOG_REMARK_HW_REG_STR);\
            }\
            else\
            {\
...
#define TILE_REG_TO_DUMP_S(a, b, c, d, e, f, max_count, result, word_no, g, h, i, j, k, l, m, n, p, q,...) \
    /* different id or word */\
    if (ISP_MESSAGE_TILE_OK == (result))\
    {\
        if ((g) != (c))\
...
typedef struct TILE_REG_MAP_STRUCT
{
    ...
    TILE_SW_REG_LUT(MSS, TILE_HW_REG_TYPE_DECLARE,,,,,)
    ...
    TILE_HW_REG_LUT(MSS, TILE_HW_REG_TYPE_DECLARE,,,,,)
...
typedef struct ISP_TILE_HEX_DUMP_STRUCT
{
	...
	/* wpe_s_d */
	unsigned int used_tile_no_wpe_s_d;
	unsigned int config_no_per_tile_wpe_s_d;
    unsigned int tile_config_wpe_s_d[MAX_ISP_TILE_TDR_HEX_NO_WPE_S];
	...
	/* mss */
	unsigned int config_no_per_tile_mss;
    unsigned int tile_config_mss[MAX_ISP_TILE_TDR_HEX_NO_MSS];
    unsigned int tile_mask_mss[MAX_ISP_MASK_HEX_PER_TILE_MSS];
    unsigned int tile_backup_mss[MAX_ISP_MASK_HEX_PER_TILE_MSS];
    TILE_INFORMATION_STRUCT tile_info_mss[MAX_TILE_TOT_NO];
    unsigned int total_word_no_mss;
	unsigned int used_word_no_mss;
	unsigned int tile_sel_mss;
	/* mss internal used */
	unsigned int config_no_per_tile_internal_mss;
    unsigned int tile_config_internal_mss[MAX_ISP_TILE_TDR_HEX_NO_INTERNAL_MSS];
    unsigned int tile_mask_internal_mss[MAX_ISP_MASK_HEX_PER_TILE_INTERNAL_MSS];
    unsigned int tile_backup_internal_mss[MAX_ISP_MASK_HEX_PER_TILE_INTERNAL_MSS];
	unsigned int total_word_no_internal_mss;
	unsigned int used_word_no_internal_mss;
